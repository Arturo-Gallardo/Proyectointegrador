...
export const FORM_SCHEMAS = {
  ...
  settingsEndpoint: {
    add: {
      ...
      fields: [
        ...
        { id: "url", label: "URL base", placeholder: "https://api.tablemetrics.com" },
        {
          id: "environment",
          label: "Entorno",
          type: "select",
  ...
  settingsIntegration: {
    ...
    delete: (itemLabel) => ({
      ...
      description: "Dejará de sincronizar datos con TableMetrics.",
...
const EDIT_FALLBACKS = {
  ...
  paymentTerms: "30",
  url: "https://api.tablemetrics.com",
  webhookUrl: "https://bistronorte.com/api/webhooks/tablemetrics",
  apiKey: "tm_live_demo_key",
  date: "2026-06-09",
  due: "2026-06-30",
...
const SAMPLE_EDIT_ITEMS = {
  ...
  settingsIntegration: { name: "Square POS", provider: "square", apiKey: "tm_live_demo_key", webhookUrl: "https://bistronorte.com/api/webhooks/tablemetrics" },
